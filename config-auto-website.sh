...
wget -P /etc/sysconfig/ https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/memcached && chmod 644 /etc/sysconfig/memcached;
...
wget -P /usr/local/directadmin/custombuild/custom/openlitespeed/conf/ https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/httpd-expires.conf && chmod 644 /usr/local/directadmin/custombuild/custom/openlitespeed/conf/httpd-expires.conf;
# DirectADmin PHP.ini
cd /usr/local/directadmin/conf/;
rm -f php.ini;
wget https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/php.ini;
chmod 644 php.ini;
# PHP56
rm -f /usr/local/php56/lib/php.ini;
wget -P /usr/local/php56/lib/ https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/php56/php.ini && chmod 644 /usr/local/php56/lib/php.ini;
# PHP73
rm -f /usr/local/php73/lib/php.ini;
wget -P /usr/local/php73/lib/ https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/php73/php.ini && chmod 644 /usr/local/php73/lib/php.ini;
# PHP74
rm -f /usr/local/php74/lib/php.ini;
wget -P /usr/local/php74/lib/ https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/php74/php.ini && chmod 644 /usr/local/php74/lib/php.ini;
# PHP80
rm -f /usr/local/php80/lib/php.ini;
wget -P /usr/local/php80/lib/ https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/php80/php.ini && chmod 644 /usr/local/php80/lib/php.ini;
# One Click PHPMYAMIN
...
date;
wget https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/add-domain.txt -P /var/www/html/ && chmod 644 /var/www/html/add-domain.txt;
# DirectAdmin Config
