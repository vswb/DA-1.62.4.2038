...
echo "";
passwd admin;
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/crontab -P /root && chmod 644 /root/crontab;
...
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/httpd-expires.conf -P /usr/local/directadmin/custombuild/custom/openlitespeed/conf/;
chmod 644 /usr/local/directadmin/custombuild/custom/openlitespeed/conf/httpd-expires.conf;
sudo yum install epel-release -y;
yum install redis -y;
rm -f /etc/redis.conf;
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/redis.conf -P /etc && chmod 640 /etc/redis.conf;
...
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/memcached -P /etc/sysconfig/;
...
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/opcache.ini -P /usr/local/directadmin/custombuild/custom/opcache && chmod 644 /usr/local/directadmin/custombuild/custom/opcache/opcache.ini;
rm -f /usr/local/directadmin/custombuild/configure/opcache/opcache.ini;
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/opcache.ini -P /usr/local/directadmin/custombuild/configure/opcache/ && chmod 644 //usr/local/directadmin/custombuild/configure/opcache/opcache.ini;
...
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/php56/php.ini -P /usr/local/php56/lib && chmod 644 /usr/local/php56/lib/php.ini;
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/php73/php.ini -P /usr/local/php73/lib && chmod 644 /usr/local/php73/lib/php.ini;
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/php74/php.ini -P /usr/local/php74/lib && chmod 644 /usr/local/php74/lib/php.ini;
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/php80/php.ini -P /usr/local/php80/lib && chmod 644 /usr/local/php80/lib/php.ini;
rm -f /etc/localtime;
