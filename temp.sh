#OVH VPS
bash <(curl -Ss https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/ovh-vps.sh || wget -O - https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/ovh-vps.sh)
...
#Install DirectAdmin
bash <(curl -Ss https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/install-directadmin.sh || wget -O - https://raw.githubusercontent.com/vswb/DA-1.62.4-key-2038/main/install-directadmin.sh)
